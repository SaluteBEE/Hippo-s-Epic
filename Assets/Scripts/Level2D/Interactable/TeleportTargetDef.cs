    ...
    public static readonly SceneEntry[] Scenes = new SceneEntry[]
    {
        new SceneEntry
        {
            ...
            interactables = new InteractableEntry[]
            {
                ...
                new InteractableEntry { entityId = "Underground Boxing Gym_Transporter", mapName = "Underground Boxing Gym" }
            }
        },
        new SceneEntry
        {
            sceneName = "Scene_Underground_Boxing_Gym",
            mapNames = new string[] { "Main Map", "Underground Boxing Gym" },
